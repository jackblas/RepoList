...
//TODO:
/*
1. Add exceptions handling
2. Add Device not online message
3. Add Invalid User/Company name message
4. Add Delete option (to delete user/company from the local database
5. Implement GitHubApi using Retrofit
 */
